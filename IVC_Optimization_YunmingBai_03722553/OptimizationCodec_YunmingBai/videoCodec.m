% motion compensated videoCodec
% output: distortion_video
%         Rate_video
tic;
...
distortion_video(scaleIdx) = mean_PSNR;
Rate_video(scaleIdx) = means_rate;

end

save('distortion_video.mat','distortion_video');
save('rate_video.mat','Rate_video');
